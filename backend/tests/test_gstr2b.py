...
from app.main import app, PURCHASES_2B, PURCHASES
...
def test_gstr2b_import_and_reconciliation_match():
    # Seed a purchase then import the matching 2B document.
    ...
    rows=client.get('/api/reconciliation?period=2026-09').json()['rows']
